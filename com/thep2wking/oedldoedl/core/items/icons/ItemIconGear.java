...
public class ItemIconGear extends Item implements IHasModel
{
	public ItemIconGear(String name)
	{
	...
	{
  		if (CoreConst.ITEM_INFORMATION && Loader.isModLoaded("oedldoedlgear"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("gear.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("gear.oedldoedl.version.tip"),
  		...
  		else
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("core.oedldoedl.gear.name.tip"),
