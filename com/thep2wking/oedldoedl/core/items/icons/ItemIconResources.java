...
public class ItemIconResources extends Item implements IHasModel
{
	public ItemIconResources(String name)
	{
	...
	{
  		if (CoreConst.ITEM_INFORMATION && Loader.isModLoaded("oedldoedlresources"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("resources.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("resources.oedldoedl.version.tip"),
  		...
  		else
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("core.oedldoedl.resources.name.tip"),
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.installed.tip")+" "+TextFormatting.RED+I18n.func_135052_a("core.oedldoedl.false.tip"),
  			});
  		}
	}
}