...
public class ItemIconConstruct extends Item implements IHasModel
{
	...
	{
  		if (CoreConst.ITEM_INFORMATION && Loader.isModLoaded("oedldoedlconstruct"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("construct.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("construct.oedldoedl.version.tip"),
  		...
  		else
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.func_135052_a("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.func_135052_a("core.oedldoedl.construct.name.tip"),
