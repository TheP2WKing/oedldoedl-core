        ...
        public Void apply(ITheOneProbe theOneProbe) {
            ...
            probe.registerProvider(new IProbeInfoProvider() {
                ...
                public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world,
                    ...
                    if (blockState.getBlock() instanceof ITOPInfoProvider && blockState != null
                            && CoreConfig.INTEGRATION.THEONEPROBE.TOP_INTEGRATION) {
            ...
            probe.registerEntityProvider(new IProbeInfoEntityProvider() {
                ...
                public void addProbeEntityInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world,
                    ...
                    if (entity instanceof ITOPEntityInfoProvider && entity != null
                            && CoreConfig.INTEGRATION.THEONEPROBE.TOP_INTEGRATION) {
