...
public class ModToolItemBase extends ToolItem {
	 ...
	 */
	public ModToolItemBase(IItemTier itemTier, float attackDamage, float attackSpeed, Set<Block> effectiveBlocks,
			Rarity rarity, boolean hasEffect, boolean fireImmunity, int tooltipLines, int annotationLines,
			Properties properties) {
		super(attackDamage, attackSpeed, itemTier, effectiveBlocks, properties.maxStackSize(1));
		this.rarity = rarity;
