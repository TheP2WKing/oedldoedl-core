...
public class ModAxeItemBase extends AxeItem {
	 ...
	 */
	public ModAxeItemBase(IItemTier itemTier, float attackDamage, float attackSpeed, Rarity rarity, boolean hasEffect,
