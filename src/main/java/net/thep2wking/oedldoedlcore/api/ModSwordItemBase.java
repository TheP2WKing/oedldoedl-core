...
public class ModSwordItemBase extends SwordItem {
	 ...
	 */
	public ModSwordItemBase(IItemTier itemTier, int attackDamage, float attackSpeed, Rarity rarity, boolean hasEffect,
