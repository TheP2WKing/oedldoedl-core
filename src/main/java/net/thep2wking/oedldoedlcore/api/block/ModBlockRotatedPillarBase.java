 ...
 * @author TheP2WKing
 */
public class ModBlockRotatedPillarBase extends BlockRotatedPillar {
	 ...
	 */
	public ModBlockRotatedPillarBase(String modid, String name, CreativeTabs tab, Material material, SoundType sound,
