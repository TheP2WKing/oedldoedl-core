...
public class ModShieldItemBase extends ShieldItem {
	 ...
	 */
	public ModShieldItemBase(IItemTier itemTier, Item repairItem, Rarity rarity, boolean hasEffect,
			boolean fireImmunity, int tooltipLines, int annotationLines, Properties properties) {
		super(properties.maxStackSize(1)
				.maxDamage((int) (itemTier.getMaxUses() * CoreConfig.shield_durability_multiplier.get())));
