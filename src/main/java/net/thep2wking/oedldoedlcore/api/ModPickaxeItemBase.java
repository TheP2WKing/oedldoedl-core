...
public class ModPickaxeItemBase extends PickaxeItem {
	 ...
	 */
	public ModPickaxeItemBase(IItemTier itemTier, int attackDamage, float attackSpeed, Rarity rarity, boolean hasEffect,
