...
public class ModShearsItemBase extends ShearsItem {
	 ...
	 */
	public ModShearsItemBase(IItemTier itemTier, Rarity rarity, boolean hasEffect, boolean fireImmunity,
			int tooltipLines, int annotationLines, Properties properties) {
		super(properties.maxStackSize(1)
				.maxDamage((int) (itemTier.getMaxUses() * CoreConfig.shears_durability_multiplier.get())));
