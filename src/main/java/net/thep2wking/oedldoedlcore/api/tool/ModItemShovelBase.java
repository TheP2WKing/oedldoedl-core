 ...
 * @author TheP2WKing
 */
public class ModItemShovelBase extends ItemSpade {
	 ...
	 */
	public ModItemShovelBase(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
	...
	public ItemSpade setRGBBarColor(int color) {
