...
public class OedldoedlCore {
    ...
    public static final String DEPENDENCIES = "required-after:forge@[14.23.5.2847,);after:jei@[4.16.1.300,);after:theoneprobe@[1.4.28,);after:baubles;after:tconstruct;after:matteroverdrive;after:jeresources";
