...
import net.thep2wking.oedldoedlcore.base.ModToolItemBase;
import net.thep2wking.oedldoedlcore.config.CoreConfig;
import net.thep2wking.oedldoedlcore.util.TipLines;

public class DebugWrenchItem extends ModToolItemBase
{
	public DebugWrenchItem(IItemTier itemTier, float attackDamage, float attackSpeed, Set<Block> effectiveBlocks, Rarity rarity, 
	boolean hasEffect, boolean fireImmunity, TipLines lines, boolean hasAnnotation, Properties properties) 
	{
		super(itemTier, attackDamage, attackSpeed, effectiveBlocks, rarity, hasEffect, fireImmunity, lines, hasAnnotation, properties);
	}
    ...
    {
    	if (CoreConfig.useable_in_survival.get() || context.getPlayer().isCreative())
    	{
    ...
    {
    	if (CoreConfig.useable_in_survival.get() || player.isCreative()) 
    	{
    		...
    		else 
    		{
    			...
    			if (rightClick) 
    			{
	                ...
	                sendMessage(player, new TranslationTextComponent("item.minecraft.debug_stick" + ".update", property.getName(), func_195957_a(blockstate, property)));
    			} 
    			else 
    			{
	                ...
	                sendMessage(player, new TranslationTextComponent("item.minecraft.debug_stick" + ".select", s2, func_195957_a(state, property)));
    			}
    		}
    	}
    }
