...
import net.thep2wking.oedldoedlcore.content.potion.PotionFlight;
...
public class ModPotions {
	...
	public static final Potion FLIGHT = new PotionFlight(OedldoedlCore.MODID, "flight", false, 0xeef6f6 , 2, 0);
