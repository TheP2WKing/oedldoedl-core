...
public class ItemIconMusic extends Item implements IHasModel
{
	public ItemIconMusic(String name)
	{
	...
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation && Loader.isModLoaded("oedldoedlmusic"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("music.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.format("music.oedldoedl.version.tip"),
  		...
  		else if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("core.oedldoedl.music.name.tip"),
