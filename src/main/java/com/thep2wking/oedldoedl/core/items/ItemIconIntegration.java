...
public class ItemIconIntegration extends Item implements IHasModel
{
	public ItemIconIntegration(String name)
	{
	...
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation && Loader.isModLoaded("oedldoedlintegration"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("integration.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.format("integration.oedldoedl.version.tip"),
  		...
  		else if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("core.oedldoedl.integration.name.tip"),
