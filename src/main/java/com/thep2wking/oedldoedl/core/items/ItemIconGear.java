...
public class ItemIconGear extends Item implements IHasModel
{
	...
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation && Loader.isModLoaded("oedldoedlgear"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("gear.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.format("gear.oedldoedl.version.tip"),
  		...
  		else if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("core.oedldoedl.gear.name.tip"),
