...
public class ItemIconResources extends Item implements IHasModel
{
	...
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation && Loader.isModLoaded("oedldoedlresources"))
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("resources.oedldoedl.name.tip"),
  				...
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.format("resources.oedldoedl.version.tip"),
  		...
  		else if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			TooltipShiftInfo.addTooltipText(tooltip, new String[]
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format("core.oedldoedl.resources.name.tip"),
