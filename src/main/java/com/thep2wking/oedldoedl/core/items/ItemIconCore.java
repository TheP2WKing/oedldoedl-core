...
public class ItemIconCore extends Item implements IHasModel
{
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced)
	{
  		if (CoreConfig.GENEREL.tooltips.itemInformation)
  		{
  			...
  			{
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.mod.tip")+" "+TextFormatting.YELLOW+I18n.format(ReferenceCore.NAME),
  				...
  				TextFormatting.DARK_GREEN+I18n.format("core.oedldoedl.version.tip")+" "+TextFormatting.YELLOW+I18n.format(ReferenceCore.VERSION),
