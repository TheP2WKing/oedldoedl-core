...
public class TooltipControlEffectInfo 
{
	...
	{
		if (GuiScreen.isCtrlKeyDown() || GuiTooltipDisplay.display_gui)
			...
			tooltip.add(TextFormatting.GRAY+""+I18n.format("core.oedldoedl.key.press.info")+
						TextFormatting.AQUA+" "+TextFormatting.ITALIC+I18n.format("core.oedldoedl.key.control")+
						TextFormatting.GRAY+" "+I18n.format("core.oedldoedl.key.control.effects"));
	}
}